...
SERVICES_CONFIG = {
    'zep-admin': {
        'package': 'zepadmin',
        'models': ['Project', 'User', 'APIKey'],
        'usecases': ['CreateProject', 'ListProjects'],
        'repo_interfaces': ['AdminRepository'],
        'grpc_service': 'ZepAdminService'
    },
    'zep-core': {
        'package': 'zepcore',
        'models': ['Memory', 'Session'],
        'usecases': ['AddMemory', 'GetMemory'],
        'repo_interfaces': ['CoreRepository'],
        'grpc_service': 'ZepCoreService'
    },
    'zep-graph': {
        'package': 'zepgraph',
        'models': ['Node', 'Edge', 'Graph'],
        'usecases': ['AddNode', 'AddEdge', 'Traverse'],
        'repo_interfaces': ['GraphRepository'],
        'grpc_service': 'ZepGraphService'
    },
    'zep-memory': {
        'package': 'zepmemory',
        'models': ['MemorySummary', 'Context'],
        'usecases': ['Summarize', 'GetContext'],
        'repo_interfaces': ['MemoryRepository'],
        'grpc_service': 'ZepMemoryService'
    },
    'zep-search': {
        'package': 'zepsearch',
        'models': ['SearchQuery', 'SearchResult'],
        'usecases': ['VectorSearch', 'BM25Search', 'MMRSearch'],
        'repo_interfaces': ['SearchRepository'],
        'grpc_service': 'ZepSearchService'
    },
    'zep-thread': {
        'package': 'zepthread',
        'models': ['Thread', 'Message'],
        'usecases': ['CreateThread', 'AddMessage', 'ListThreads'],
        'repo_interfaces': ['ThreadRepository'],
        'grpc_service': 'ZepThreadService'
    },
    'zep-user': {
        'package': 'zepuser',
        'models': ['User', 'UserPreference'],
        'usecases': ['CreateUser', 'GetUser', 'UpdateUser'],
        'repo_interfaces': ['UserRepository'],
        'grpc_service': 'ZepUserService'
    }
}
