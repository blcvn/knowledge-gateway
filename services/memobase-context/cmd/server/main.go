...
// Enterprise-grade bootstrap for memobase-context
func main() {
	...
	slog.Info("Initializing memobase-context at enterprise-grade...")

	// 2. Initialize OpenTelemetry Distributed Tracing
	shutdownTracer, err := telemetry.InitProvider(ctx, "memobase-context")
	if err != nil {
	...
	healthCheck.SetServingStatus("memobase-context", grpc_health_v1.HealthCheckResponse_SERVING)
