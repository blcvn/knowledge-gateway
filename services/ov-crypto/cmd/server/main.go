...
// Enterprise-grade bootstrap for ov-crypto
func main() {
	...
	slog.Info("Initializing ov-crypto at enterprise-grade...")

	// 2. Initialize OpenTelemetry Distributed Tracing
	shutdownTracer, err := telemetry.InitProvider(ctx, "ov-crypto")
	if err != nil {
	...
	healthCheck.SetServingStatus("ov-crypto", grpc_health_v1.HealthCheckResponse_SERVING)
