...
// Enterprise-grade bootstrap for ov-resource
func main() {
	...
	slog.Info("Initializing ov-resource at enterprise-grade...")

	// 2. Initialize OpenTelemetry Distributed Tracing
	shutdownTracer, err := telemetry.InitProvider(ctx, "ov-resource")
	if err != nil {
	...
	healthCheck.SetServingStatus("ov-resource", grpc_health_v1.HealthCheckResponse_SERVING)
