...
// Enterprise-grade bootstrap for sm-project
func main() {
	...
	slog.Info("Initializing sm-project at enterprise-grade...")

	// 2. Initialize OpenTelemetry Distributed Tracing
	shutdownTracer, err := telemetry.InitProvider(ctx, "sm-project")
	if err != nil {
	...
	healthCheck.SetServingStatus("sm-project", grpc_health_v1.HealthCheckResponse_SERVING)
