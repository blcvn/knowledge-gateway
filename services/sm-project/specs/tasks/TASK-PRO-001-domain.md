---
id: TASK-PRO-001
title: Domain Models & RBAC Algorithm
service: sm-project
status: Done
priority: P0
created: 2026-05-11
...
# Domain Models & RBAC Algorithm

## Objective
Implement Space, SpaceMember. Implement the RBAC Resolution Algorithm based on visibility and roles.
...
- [x] 100% alignment with the `specs/tdd.md` document for `sm-project`.
