...
var KGNodeTypes = []biz.EntityType{
	// PRD/URD Layer
	{AppID: "system", Name: "Feature", Description: "Product feature from PRD", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "UserStory", Description: "User story from PRD", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "BusinessRule", Description: "Business rule", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "Actor", Description: "System actor/user role", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "UseCase", Description: "Use case definition", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "DataEntity", Description: "Domain data entity", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "Constraint", Description: "System constraint", Schema: datatypes.JSON("{}")},
	// SRS Layer
	{AppID: "system", Name: "SRSRequirement", Description: "Structured software requirement (v4.0)", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "SystemInterface", Description: "System interface spec (v4.0)", Schema: datatypes.JSON("{}")},
	// UI Doc Layer
	{AppID: "system", Name: "UIScreen", Description: "UI screen (v4.0)", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "UIComponent", Description: "UI component (v4.0)", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "UIFlow", Description: "UI navigation flow (v4.0)", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "UIValidationRule", Description: "UI field validation rule (v4.0)", Schema: datatypes.JSON("{}")},
	// Test Artifact Layer
	{AppID: "system", Name: "TestRequirement", Description: "Test requirement derived from features", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "TestDesign", Description: "Test design document", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "TestCase", Description: "Individual test case", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "TestSuite", Description: "Test suite grouping", Schema: datatypes.JSON("{}")},
	{AppID: "system", Name: "TestScript", Description: "Automated test script", Schema: datatypes.JSON("{}")},
}
