...
func NewHTTPServer(c *conf.Server, greeter *service.GreeterService, registry *service.RegistryService, ont *service.OntologyService, g *service.GraphService, ruleSrv *service.RulesService, policySrv *service.PolicyService, graphHTTP *service.GraphHTTPHandler, logger log.Logger) *http.Server {
	...
	// Extra HTTP routes (not from proto): project-scoped graph query
	service.RegisterGraphHTTPRoutes(srv, graphHTTP)
	return srv
}
