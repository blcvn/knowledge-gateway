...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	opaClient := biz.NewOPAClient(confData, logger)
	...
	graphHTTPHandler := service.NewGraphHTTPHandler(graphUsecase)
	...
	httpServer := server.NewHTTPServer(confServer, greeterService, registryService, ontologyService, graphService, rulesService, policyService, graphHTTPHandler, logger)
