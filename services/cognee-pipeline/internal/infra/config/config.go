// Package config provides configuration loading for cognee-pipeline.
package config
...
// Config holds all configuration for the cognee-pipeline service.
type Config struct {
...
func Load() (*Config, error) {
	cfg := &Config{
		GRPCPort:     envInt("GRPC_PORT", 9011),
