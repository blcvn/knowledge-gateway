---
id: FEAT-009
title: Triển khai Infrastructure Health Module
service: ui
version: 1.0.0
status: Ready
priority: P1
...
1. `InfrastructurePage.tsx`
2. `ServiceStatusGrid.tsx`: Các thẻ trạng thái của các core service (Gateway, Memory Engine, Embedding Service, Neo4j, Qdrant).
3. `ResourceUtilizationCharts.tsx`: Biểu đồ Line/Area hiển thị CPU, RAM của từng node (Recharts).
