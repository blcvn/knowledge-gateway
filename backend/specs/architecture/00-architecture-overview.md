...
> **Version**: 1.1 | **Date**: 2026-05-09 | **Status**: Proposed  
> **Stack**: Go 1.23+ · gRPC · NATS JetStream · PostgreSQL · Neo4j · Qdrant · Redis · SurrealDB (optional)  
...
| **OpenViking (Procedural)** | ov-fs, ov-search, ov-session, ov-resource, ov-crypto, ov-admin | 6 | VikingFS, tiered context, encryption |
...
| **Platform** | vnp-event, vnp-search-hub, vnp-admin | 3 | Cross-engine orchestration |
...
| **Relational DB** | PostgreSQL 17 + pgvector | Admin, Memobase, Cognee metadata |
| **Graph DB** | Neo4j 5.x (primary), FalkorDB/Kuzu (pluggable) | Cognee KG + Graphiti episodic |
| **Vector DB** | Qdrant / pgvector | Cognee search, Memobase events |
