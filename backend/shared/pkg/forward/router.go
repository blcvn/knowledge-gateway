		...
		Methods: []grpc.MethodDesc{
			{
				...
				Handler: func(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
					...
					if interceptor == nil {
						resp, err := router.Forward(ctx, req.Value)
						if err != nil {
							return nil, err
						}
						return &wrapperspb.BytesValue{Value: resp}, nil
					}
					...
					handler := func(ctx context.Context, req interface{}) (interface{}, error) {
						reqMsg := req.(*wrapperspb.BytesValue)
						respBytes, err := router.Forward(ctx, reqMsg.Value)
						if err != nil {
							return nil, err
						}
