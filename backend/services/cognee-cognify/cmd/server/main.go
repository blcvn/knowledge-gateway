...
// Enterprise-grade bootstrap for cognee-cognify
func main() {
	...
	slog.Info("Initializing cognee-cognify at enterprise-grade...")

	// 2. Initialize OpenTelemetry Distributed Tracing
	shutdownTracer, err := telemetry.InitProvider(ctx, "cognee-cognify")
	if err != nil {
	...
	healthCheck.SetServingStatus("cognee-cognify", grpc_health_v1.HealthCheckResponse_SERVING)
