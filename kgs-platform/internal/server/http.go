...
func NewHTTPServer(c *conf.Server, greeter *service.GreeterService, registry *service.RegistryService, ont *service.OntologyService, g *service.GraphService, ruleSrv *service.RulesService, policySrv *service.PolicyService, registryUC *biz.RegistryUsecase, redisCli *redis.Client, logger log.Logger) *http.Server {
