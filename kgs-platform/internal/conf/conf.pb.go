...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xcf\x04\n" +
	"\x04Data\x125\n" +
	"\bdatabase\x18\x01 \x01(\v2\x19.kratos.api.Data.DatabaseR\bdatabase\x12,\n" +
	"\x05redis\x18\x02 \x01(\v2\x16.kratos.api.Data.RedisR\x05redis\x12,\n" +
	"\x05neo4j\x18\x03 \x01(\v2\x16.kratos.api.Data.Neo4jR\x05neo4j\x12&\n" +
	"\x03opa\x18\x04 \x01(\v2\x14.kratos.api.Data.OPAR\x03opa\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\rwrite_timeout\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\x1ae\n" +
	"\x05Neo4j\x12\x10\n" +
	"\x03uri\x18\x01 \x01(\tR\x03uri\x12\x12\n" +
	"\x04user\x18\x02 \x01(\tR\x04user\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\x12\x1a\n" +
	"\bdatabase\x18\x04 \x01(\tR\bdatabase\x1a\x17\n" +
	"\x03OPA\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03urlB!Z\x1fkgs-platform/internal/conf;confb\x06proto3"
